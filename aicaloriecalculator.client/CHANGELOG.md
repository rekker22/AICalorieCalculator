...
- Create Angular project with ng: `ng new aicaloriecalculator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aicaloriecalculator.client.esproj`).
